...
public class Main {
    public static void main(String[] args) {
       ...
       //global.append(getCsv(mainPath, ".process", "SUBPROCESS", "config.processNameXPath","any","any", "any")).append("\n");
        ...
        System.out.println("PROCESS PATH,CLUSTER,CHARS,LINES,ACTIVITIES,TRANSITIONS,SUBPROCESS,DISCT_SUBPROCESS,MAPPERS,SOAP,JDBC,SP,HTTP_REC,HTTP_REQ,INV_REST");
